...
{\sl People + Technology Lab, NYU} (\href{https://www.codesignwithdata.com/}{link})\hfill
Current \\
Visiting Researcher, under Pfr. Graham Dove  \\
\begin{itemize}
\item Working with ITP Lab to develop creative, gamified interfaced metaphors for LLMs
\end{itemize}
...
\item Work will be submitted to C\&C 2026
\end{itemize}
...
{\sl Broad Institute of MIT-Harvard} (\href{https://www.broadinstitute.org/}{link}) \hfill Summer 2008 \\
Research Assistant \\
\begin{itemize}
\item Developed system for finding connections between gene loci based on Yahoo! search engine
%\item Assisted with wet lab experiments
\end{itemize}
